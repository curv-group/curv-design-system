...
export const COMPONENTS = [
  ...
  { name: "Drawer", group: "feedback", summary: "Floating inline record peek (Linear / Shopify). Page narrows; the sheet is a muted well with white section cards. Showcase is the full surface — OS apps may use a subset. Copy examples/drawer.tsx.", example: "examples/drawer.tsx", props: ["trigger", "open", "defaultOpen", "onOpenChange", "side", "size", "title", "description", "badge", "headerActions", "children", "footer"] },
  { name: "DrawerSection", group: "feedback", summary: "Raised white section card inside a drawer. Sentence-case title. Air between cards, rows tight inside.", props: ["title", "children", "className"] },
  { name: "DrawerRow", group: "feedback", summary: "Property row: optional icon, fixed label, left-aligned value. Linear/Attio rhythm.", props: ["label", "icon", "children"] },
