...
export const COMPONENTS = [
  ...
  { name: "Drawer", group: "feedback", summary: "Floating inline record peek (Linear / Shopify). Page narrows; peek is a column of cards on the canvas. Showcase is the full surface — OS apps may use a subset. Copy examples/drawer.tsx.", example: "examples/drawer.tsx", props: ["trigger", "open", "defaultOpen", "onOpenChange", "side", "size", "title", "description", "badge", "headerActions", "children", "footer"] },
